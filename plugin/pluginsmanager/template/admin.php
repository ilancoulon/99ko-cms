	...
	<table style="width:100%">
	  ...
	  <tbody>			  	
		...
		<tr>
			...
			<?php echo lang('Author'); ?> : <?php echo utilHideEmail($plugin->getInfoVal('authorEmail')); ?> 
			<a class="label secondary round" href="<?php echo $plugin->getInfoVal('authorWebsite'); ?>" onclick="window.open(this.href);return false;"><?php echo $plugin->getInfoVal('authorWebsite'); ?></a>
			</td>
