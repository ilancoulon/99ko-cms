...
defined('ROOT') OR exit('No direct script access allowed');
    ...
    /**
     * affiche l'identifiant du plugin
     */
    ...
    /**
     * Affiche le fil d'Ariane !! OBSOLETE !!
     */
     function showBreadcrumb($format = '<li><a href="[target]">[label]</a></li>') {
     	...
     	$temp = $format;
     	$temp = str_replace('[target]', getCoreConf('siteUrl'), $temp);
     	$temp = str_replace('[label]', lang('You are here')."&nbsp;&nbsp;:&nbsp;&nbsp;".lang('Home'), $temp);
     	$data.= $temp;
